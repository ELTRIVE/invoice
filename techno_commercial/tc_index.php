...
/* Page 1 fixed document sheet */
.tc-doc-wrap{display:flex;justify-content:center;padding:8px 0 22px;}
.tc-doc-sheet{
  width:860px; min-height:1180px; background:#fff; border:1px solid #222;
  position:relative; box-shadow:0 10px 28px rgba(0,0,0,.08); overflow:hidden;
}
.tc-doc-watermark{
  position:absolute; inset:120px 0 120px 0; display:flex; align-items:center; justify-content:center;
  pointer-events:none; opacity:.11;
}
.tc-doc-watermark img{width:300px; max-width:60%;}
.tc-doc-head{
  display:grid; grid-template-columns:170px 1fr; align-items:center;
  border-bottom:1px solid #20c25e; min-height:64px;
}
.tc-doc-logo{
  padding:10px 12px; border-right:1px solid #222; min-height:64px; display:flex; align-items:center;
}
.tc-doc-logo img{max-width:120px; width:100%; height:auto;}
.tc-doc-title{
  padding:10px 16px; font-size:14px; color:#111; line-height:1.35;
}
.tc-doc-body{padding:74px 44px 0;}
.tc-meta-table{width:100%; border-collapse:collapse; margin-bottom:70px;}
.tc-meta-table td{padding:6px 0; font-size:14px; vertical-align:top;}
.tc-meta-label{
  width:160px; font-weight:700; color:#111; padding-right:18px;
}
.tc-meta-value input{
  width:100%; border:none; border-bottom:1px solid transparent; background:transparent;
  font-family:'Times New Roman',Times,serif; font-size:14px; color:#111; padding:0;
}
.tc-meta-value input:focus{outline:none; border-bottom-color:#9ca3af;}
.tc-block-title{
  font-size:15px; font-weight:700; color:#111; margin:0 0 8px;
}
.tc-grid-table{width:100%; border-collapse:collapse; background:transparent;}
.tc-grid-table th,.tc-grid-table td{border:1px solid #222; padding:0; font-size:12px;}
.tc-grid-table th{
  background:#f7f7f7; font-weight:700; text-align:left; padding:3px 6px;
}
.tc-grid-table td input{
  width:100%; border:none; outline:none; background:transparent; padding:7px 6px;
  font-size:11.5px; color:#111; font-family:'Segoe UI',sans-serif;
}
.tc-grid-table td input:focus{background:#f8fbff;}
.tc-grid-table td .tc-readonly-role{
  display:block; padding:7px 6px; font-size:11.5px; color:#111;
}
.tc-grid-table .narrow-action{width:42px; text-align:center;}
.tc-grid-table .narrow-action button{background:none;border:none;color:#b91c1c;cursor:pointer;}
.tc-revision-wrap{margin-top:88px;}
.tc-footer{
  position:absolute; left:0; right:0; bottom:0; border-top:1px solid #222; background:#fff;
}
.tc-footer-table{width:100%; border-collapse:collapse;}
.tc-footer-table td{
  border:1px solid #222; padding:2px 5px; font-size:10px; line-height:1.15; vertical-align:top;
}
.tc-footer-label{width:88px;}
.tc-footer-table input{
  width:100%; border:none; outline:none; background:transparent; font-size:10px; padding:0;
  font-family:'Segoe UI',sans-serif; color:#111;
}
.tc-footer-table input:focus{background:#f8fbff;}
.tc-footer-company{
  font-weight:800; font-size:11px; line-height:1.15; letter-spacing:.1px;
}
.tc-footer-doc-title{font-weight:700;}
...
<div class="app-layout">
    ...
    <?php
    $sidebarPath = dirname(__DIR__) . '/sidebar.php';
    ...
    <div class="tc-main">
        ...
        <div class="content-area">
        <div class="doc-form tc-doc-wrap">
            <div class="tc-doc-sheet">
                <div class="tc-doc-watermark">
                    <img src="/invoice/assets/watermark.png" alt="Watermark">
                </div>

                <div class="tc-doc-head">
                    <div class="tc-doc-logo">
                        <img src="/invoice/assets/eltrive-logo.png" alt="Eltrive">
                    </div>
                    <div class="tc-doc-title">
                        <input id="mp-footer-title" type="text" placeholder="Safe Hydra- Fire Hydrant Pump House Monitoring System" style="width:100%;border:none;outline:none;background:transparent;font-size:14px;font-family:'Segoe UI',sans-serif;color:#111;">
                    </div>
                </div>

                <div class="tc-doc-body">
                    <table class="tc-meta-table">
                        <tr>
                            <td class="tc-meta-label">Project:</td>
                            <td class="tc-meta-value"><input id="mp-project-name" type="text" placeholder="Safe Hydra- Fire Hydrant Pump House Monitoring System"></td>
                        </tr>
                        <tr>
                            <td class="tc-meta-label">Document Key:</td>
                            <td class="tc-meta-value">
                                <div style="display:flex;align-items:center;gap:8px;">
                                    <input id="mp-document-key" type="text" placeholder="Auto-generating…">
                                    <button type="button" onclick="refreshDocKey()" title="Regenerate key" style="background:none;border:none;color:#16a34a;cursor:pointer;font-size:14px;padding:0 2px;" id="doc-key-refresh-btn"><i class="fas fa-sync-alt"></i></button>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="tc-meta-label">Version:</td>
                            <td class="tc-meta-value"><input id="mp-version" type="text" placeholder="Initial Release"></td>
                        </tr>
                        <tr>
                            <td class="tc-meta-label">Revision</td>
                            <td class="tc-meta-value"><input id="mp-revision" type="text" placeholder="1.0"></td>
                        </tr>
                        <tr>
                            <td class="tc-meta-label">Customer</td>
                            <td class="tc-meta-value"><input id="mp-customer" type="text" placeholder="M/S Aragen Pharma, Nacharam"></td>
                        </tr>
                    </table>
                    ...
                    <table class="tc-grid-table">
                        ...
                        <tbody id="approval-tbody">
                            <tr>
                                <td><input type="hidden" value="Author:"><span class="tc-readonly-role">Author:</span></td>
                                <td><input type="text" placeholder="G.Chakravarthy"></td>
                                <td><input type="text" placeholder="Automation"></td>
                                <td><input type="email" placeholder="name@eltrive.com"></td>
                                <td><input type="text" placeholder="2-Apr-26"></td>
                            </tr>
                            <tr>
                                <td><input type="hidden" value="1st. Check:"><span class="tc-readonly-role">1st. Check:</span></td>
                                <td><input type="text" placeholder="V.Bhaskar Bhargavi"></td>
                                <td><input type="text" placeholder="Automation"></td>
                                <td><input type="email" placeholder="name@eltrive.com"></td>
                                <td><input type="text" placeholder="2-Apr-26"></td>
                            </tr>
                            <tr>
                                <td><input type="hidden" value="Approved"><span class="tc-readonly-role">Approved</span></td>
                                <td><input type="text" placeholder="G.Rajesh"></td>
                                <td><input type="text" placeholder="Automation"></td>
                                <td><input type="email" placeholder="name@eltrive.com"></td>
                                <td><input type="text" placeholder="6-Apr-26"></td>
                            </tr>
                        </tbody>
                    </table>

                    <div class="tc-revision-wrap">
                        <div class="tc-block-title">Revision History</div>
                        <table class="tc-grid-table">
                            <thead>
                                <tr>
                                    <th style="width:11%;">Version</th>
                                    <th style="width:17%;">Previous Ver</th>
                            ...
                            <tbody id="revision-tbody">
                                <tr>
                                    ...
                                    <td><input type="text" placeholder="AA"></td>
                                    <td><input type="text" placeholder="3-Apr-6"></td>
                                    <td><input type="text" placeholder="Initial Release"></td>
                                    <td class="narrow-action"><button type="button" onclick="this.closest('tr').remove()"><i class="fas fa-times"></i></button></td>
                                </tr>
                            </tbody>
                        </table>
                        <div style="margin-top:8px;">
                            <button class="btn btn-outline btn-sm" onclick="addRevisionRow()"><i class="fas fa-plus"></i> Add Revision</button>
                        </div>
                    </div>
                </div>

                <div class="tc-footer">
                    <table class="tc-footer-table">
                        <tr>
                            <td class="tc-footer-label">Designed by</td>
                            <td><input id="mp-designed-by" type="text" placeholder="G.Chakravarthy"></td>
                            <td><input id="mp-asst-manager" type="text" placeholder="Assistant Manager"></td>
                            <td class="tc-footer-label">Template Ver:</td>
                            <td><input id="mp-template-ver" type="text" placeholder="Rev:1.0"></td>
                        </tr>
                        <tr>
                            <td class="tc-footer-label">Released by</td>
                            <td><input id="mp-released-by" type="text" placeholder="V.Bhaskar Bhargavi"></td>
                            <td><input id="mp-automation-lead" type="text" placeholder="Automation Lead"></td>
                            <td class="tc-footer-label">Document Key:</td>
                            <td><input id="mp-footer-doc-key" type="text" placeholder="ELT-QT-2551V1"></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <div class="tc-footer-company"><input id="mp-company-name" type="text" placeholder="ELTRIVE AUTOMATIONS PVT LTD" style="font-weight:800;font-size:11px;"></div>
                                <input id="mp-contact-email" type="email" placeholder="automations@eltrive.com">
                            </td>
                            <td colspan="2">
                                <div class="tc-footer-doc-title"><input id="mp-footer-title-footer" type="text" placeholder="Safe Hydra- Fire Hydrant Pump House Monitoring System" readonly></div>
                                <input type="text" value="Monitoring System" readonly>
                            </td>
                            <td><input id="mp-page-no" type="text" placeholder="1"></td>
                        </tr>
                        <tr>
                            <td colspan="4"></td>
                            <td><input id="mp-footer-version" type="text" placeholder="6-Apr-26"></td>
                        </tr>
                    </table>
                </div>
            </div>
...
function syncTcCoverTitle(){const src=document.getElementById('mp-footer-title');const dst=document.getElementById('mp-footer-title-footer');if(src&&dst)dst.value=src.value||'';}
...
function newProject(){
  ...
  if(aBody){
    aBody.innerHTML = '';
    addApprovalRow('Author:','','','','');
    addApprovalRow('1st. Check:','','','','');
    addApprovalRow('Approved','','','','');
  }
...
function addApprovalRow(role='',name='',dept='',email='',date=''){
  ...
  tr.innerHTML=`
    <td><input type="hidden" value="${esc(role)}"><span class="tc-readonly-role">${esc(role || 'Role')}</span></td>
    ...
    <td><input type="text" value="${esc(date)}" placeholder="2-Apr-26"></td>`;
...
document.addEventListener('DOMContentLoaded', async function(){
  ...
  const coverTitleInput = document.getElementById('mp-footer-title');
  if(coverTitleInput){
    coverTitleInput.addEventListener('input', syncTcCoverTitle);
    syncTcCoverTitle();
  }
  if(mpSel){
    await loadProjectOptions('mp-project-select');
