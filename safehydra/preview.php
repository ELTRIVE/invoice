<?php
// safehydra/preview.php — Serves the ORIGINAL template PDF inline for preview in iframe
// This always shows the unmodified template document.

$pdfPath = __DIR__ . '/safe_hydra_template.pdf';
...
<div class="box">
  ...
  <code>safehydra/safe_hydra_template.pdf</code>
</div>
</body></html>';
    exit;
}

// Serve the original template PDF inline — no download prompt
