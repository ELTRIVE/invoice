...
<div class="content">
    ...
    <div class="page-header">
        <div class="page-header-left">
            ...
            <div>
                <div class="page-title">Add Stock Item</div>
                <div class="page-sub">Fill in the details to add a new stock item</div>
            </div>
        </div>
        <?php
    ...
    <form method="post">
            ...
            <div class="fc">
                ...
                <div class="fc-body">
                    <div class="fg">
                        <div class="field">
                            <label>UOM</label>
                            <input type="text" name="uom" placeholder="Nos / Kg / Mtr">
                        </div>
                        <div class="field">
                            <label>Qty</label>
                            <input type="number" name="qty" id="qty" placeholder="0" min="0" step="any">
                        </div>
                        <div class="field full">
                ...
                <div class="fc-body">
                    <div class="fg">
                        <div class="field">
                            ...
                            <input type="number" step="0.01" name="unit_price" id="unit_price" placeholder="0.00" min="0">
                        </div>
                        <div class="field">
                            <label>Basic Amount (&#8377;)</label>
                            <input type="number" step="0.01" name="basic_amount" id="basic_amount" placeholder="auto-calculated" readonly>
                        </div>
                        <div class="field">
                            <label>Discount %</label>
                            <input type="number" step="0.01" name="discount_percent" id="discount_percent" placeholder="0.00" min="0" max="100">
                        </div>
                        <div class="field">
                            <label>P &amp; F %</label>
                            <input type="number" step="0.01" name="pf_percent" id="pf_percent" placeholder="0.00" min="0">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="fc">
                ...
                <div class="fc-body">
                    <div class="fg3">
                        <div class="field">
                            <label>SGST %</label>
                            <input type="number" step="0.01" name="sgst" id="sgst" placeholder="0.00" min="0">
                        </div>
                        <div class="field">
                            <label>CGST %</label>
                            <input type="number" step="0.01" name="cgst" id="cgst" placeholder="0.00" min="0">
                        </div>
                        <div class="field">
                            <label>IGST %</label>
                            <input type="number" step="0.01" name="igst" id="igst" placeholder="0.00" min="0">
                        </div>
                        <div class="field">
                            <label>TCS %</label>
                            <input type="number" step="0.01" name="tcs_percent" id="tcs_percent" placeholder="0.00" min="0">
                        </div>
                        <div class="field span2">
                            <label>Total Amount (&#8377;)</label>
                            <input type="number" step="0.01" name="total" id="total" placeholder="auto-calculated" readonly>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="fc" style="margin-bottom:0">
            <div class="bottom-actions">
                <button type="submit" class="btn-save"><i class="fas fa-save"></i> Save Stock</button>
