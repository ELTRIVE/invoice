                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" name="quot_number"
                               ...
                               <?= $edit_id ? 'readonly style="background:#f9fafb;color:#6b7280"' : '' ?>>
