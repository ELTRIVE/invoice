...
@media(max-width:600px){.top-stats{grid-template-columns:1fr}.dashboard-page .content{margin-left:0;width:100%;padding:8px 12px 6px !important;height:calc(100dvh - 52px);max-height:calc(100vh - 52px)}}
